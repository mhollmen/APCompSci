public class P2F
  ...
  public static void main (String args [])
    ...
    for(int index = 0; index < batting.length; index++)
      {
      double average = Math.random() * 0.501;
      batting [index] = average;
      }
    for(int index = 0; index < batting.length; index++)
      {
          String precision = String.format("%.3f",batting[index]);
          System.out.println (precision);
      }
    double max = batting[0];  
    for(int index = 0; index < batting.length; index++)
      {
      if (batting [index] > max)
        {
        max=batting[index];
        }
      }
      String precision = String.format("%.3f",max);
      System.out.println ("The maximum batting average is " + precision);
    }
  }
 /*
